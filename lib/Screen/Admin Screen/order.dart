...
class _OrderScreenState extends State<OrderScreen> {
  ...
  Subscription? _subscriptionSec;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    orderController.isLoading.value = false;
    orderController.isLoadingSec.value = false;
  }

  @override
  void dispose() {
    _subscription?.unsubscribe();
    _subscriptionSec?.unsubscribe();
    super.dispose();
  }
  ...
  Future<File> compressImageSec(File imageFile) async {
    orderController.isLoading.value = true;
    try {
      final compressedImageBytes = await FlutterImageCompress.compressWithFile(
        imageFile.path,
  ...
  Future<File> compressVideoSec(File videoFile) async {
    ...
    try {
      ...
      // Listen to progress updates
      _subscriptionSec = VideoCompress.compressProgress$.subscribe((progress) {
      //   orderController.progressedSec.value = progress;
      //
        debugPrint('Compression progress: ${progress.toStringAsFixed(2)}%');
      });
  ...
  Future<void> _pickImages() async {
    ...
    for (var file in pickedFiles) {
      if (file.path.endsWith('.jpg') ||
        ...
        final compressedImage = await compressImageSec(imageFile);
        ...
        orderController.isLoadingSec.value = true;
        final compressedVideo = await compressVideoSec(videoFile);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:  Obx(
              () =>  ( orderController.isLoading.value == true || orderController.isLoadingSec.value == true)
              ?  SizedBox() :  Padding(
            padding: EdgeInsets.symmetric(horizontal: deviceWidth * 0.05),
            child: NextButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    if (orderController.imageNotes == null && orderController.subimageList.isEmpty) {
            ...
            child: Obx(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      borderRadius: BorderRadius.circular(8),
                      onTap:  orderController.imageNotesLocal != null ? () {
                        ...
                        if(orderController.isLoading.value == true || orderController.isLoadingSec.value == true){
                          Utils().toastMessage("Please Wait, While Uploading..");
                        }else {
                          showDialog<void>(
                            context: context,
                            builder: (BuildContext
                      ...
                      child: Container(
                        ...
                        child:  Stack(
                          children: [
                              ...
                              child: Center(
                                ...
                                Container(
                                  child: orderController.imageNotesLocal != null
                                      ? orderController.imageNotesLocal!.path.toString().endsWith('.mp4')
                            ...
                            SizedBox(
                              child: orderController.isLoading.value == true ? SizedBox(
                              ) : Container(
                                child: orderController.imageNotesLocal != null
                                    ? IconButton(
                                    onPressed: () {
                  ...
                  // Center(
                  //     child: (orderController.isLoading.value == true) ? Text(
                                ...
                                return Stack(
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        child:
                                        orderController.subimageList.isNotEmpty
                                            ? IconButton(
                                            onPressed: () {
                                            ...
                                            icon: SizedBox(
                                              child:orderController.isLoadingSec.value == true ? SizedBox(
                                              ) : Container(
                                                decoration:
                                                const BoxDecoration(
                                                    shape: BoxShape
                  ...
                  // Center(
                  //     child: (orderController.isLoadingSec.value == true) ? Text(
                  //         'Compression progress: ${orderController.progressedSec.value.toStringAsFixed(2)}%',
                  //         style: const TextStyle(color: Colors.white)) : SizedBox() ),
                  Center(
                      child: (orderController.isLoadingSec.value == true) ? Text(
                          'Please Wait, While Uploading..',
